...
from djangotest.hoopaloo_test.models import Student, Submission, Assistant, Class
from djangotest.hoopaloo_test.forms import LoginForm, ForgotPasswordForm, ChangePasswordForm
