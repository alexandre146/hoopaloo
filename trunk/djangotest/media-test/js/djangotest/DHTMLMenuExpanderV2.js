...
for (s=0; s<SUBTABLECol.length; s++)
	...
	if(TDChildrenCol.length>0)
		...
		if(ImagePlacement=='before')
			{
			//var str='<IMG border="0" src="../../img/pythonwebtester/'+imagePLUS+'" alt="Expand ALL">&nbsp;';
...
for (a=0; a<TABLECol.length; a++)
	...
	if (IMGCol.item(0)!=null){IMGCol.item(0).setAttribute('src','../../img/pythonwebtester/'+imagePLUS);}
...
if (TABLECol!=null)
	...
	for (z=0; z<TABLECol.length; z++)
		...
		if(State==0)
			...
			if (IMGCol.item(0)!=null){IMGCol.item(0).setAttribute('src','../../img/pythonwebtester/'+imageMINUS);}
