...
urlpatterns = patterns('',
	...
	(r'^hoopaloo/undertest_view/id=(?P<undertest_id>\d+)$', 'projectdjango.hoopaloo.test_views.undertest_view'),
	(r'^hoopaloo/save_under_test/id=(?P<undertest_id>\d+)/$', 'projectdjango.hoopaloo.test_views.save_under_test'),
	(r'^hoopaloo/under_test_action/id=(?P<exercise_id>\d+)/$', 'projectdjango.hoopaloo.test_views.under_test_action'),
