...
urlpatterns = patterns('',
	...
	(r'^hoopaloo/submission/student(?P<student_id>\d+)/exercise/id=(?P<exercise_id>\d+)$', 'projectdjango.hoopaloo.submission_views.view_exercise'),
	(r'^hoopaloo/submission/student(?P<student_id>\d+)/exercise/id=(?P<exercise_id>\d+)/$', 'projectdjango.hoopaloo.submission_views.view_exercise'),
...
if settings.DEBUG:
    urlpatterns += patterns('',
		...
		#(r'^media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': 'C:/Documents and Settings/Mari/Meus documentos/projectdjango/media/'}),
		#(r'^admin-media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': 'C:/Documents and Settings/Mari/Meus documentos/projectdjango/admin-media/'}),
    )
