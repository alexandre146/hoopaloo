...
class Teste1_4 (unittest.TestCase): 
	...
	def testDuasRaizes1(self):
        	child = spawn('python /home/mariana/www/projectdjango/media/uploads/mariana//Roteiro1_Ex1.4.py')
        	child.sendline('1')
        	child.sendline('-5')
        	child.sendline('6')
        	child.expect('.*')
...
if __name__== '__main__':
	suite = unittest.TestLoader().loadTestsFromTestCase(Teste1_4)
	r = TestResult()
	suite.run(r)
