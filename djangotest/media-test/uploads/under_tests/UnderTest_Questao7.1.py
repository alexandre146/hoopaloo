...
class UnderTest_Questao7_1 (unittest.TestCase): 
	...
	def test_investimento(self):
		child = spawn('python /home/mariana/www/djangotest/media-test/uploads/under_tests/UnderTest_Questao7.1.py/Questao7.1.py')
...
if __name__== '__main__':
	...
	suite = loader.loadTestsFromTestCase(UnderTest_Questao7.1)
	r = TestResult()
	suite.run(r)
	result_file = open('/home/mariana/www/djangotest/media-test/uploads/under_tests/UnderTest_Questao7.1.py' + 'result.txt', 'wb')
